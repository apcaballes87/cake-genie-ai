...
/**
 * Represents a simplified accessory object stored in the cart.
 * Contains the necessary fields for display and logic like availability calculation.
 */
export interface CartAccessory {
  description: string;
  type: MainTopperType | SupportElementType;
  size?: Size;
  coverage?: Coverage;
}
...
export interface CartItemDetails {
  flavors: string[];
  mainToppers: CartAccessory[];
  supportElements: CartAccessory[];
  cakeMessages: { 
    text: string; 
