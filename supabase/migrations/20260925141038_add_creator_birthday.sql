-- Keep historical creator applications unchanged; new submissions must include a valid birthday.
ALTER TABLE public.creators
    ADD COLUMN IF NOT EXISTS birthday DATE;

COMMENT ON COLUMN public.creators.birthday IS
    'Creator birthday used to plan an annual birthday cake surprise.';

DROP FUNCTION IF EXISTS public.submit_creator_application(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, INTEGER, TEXT, INTEGER, TEXT, INTEGER, TEXT, BOOLEAN);

CREATE FUNCTION public.submit_creator_application(
    p_name TEXT,
    p_email TEXT,
...
BEGIN
    ...
    IF p_birthday IS NULL
       OR p_birthday > (now() AT TIME ZONE 'Asia/Manila')::date THEN
        RAISE EXCEPTION 'Please provide a valid birthday.'
            USING ERRCODE = '22023';
    END IF;
...
REVOKE ALL ON FUNCTION public.submit_creator_application(
    TEXT, TEXT, TEXT, TEXT, TEXT, DATE, TEXT, INTEGER, TEXT, INTEGER, TEXT, INTEGER, TEXT, BOOLEAN
