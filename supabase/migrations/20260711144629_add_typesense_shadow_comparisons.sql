CREATE TABLE IF NOT EXISTS public.cakegenie_search_shadow_comparisons (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    query TEXT NOT NULL,
    baseline_slugs TEXT[] NOT NULL DEFAULT '{}',
    typesense_slugs TEXT[] NOT NULL DEFAULT '{}',
    baseline_count INTEGER NOT NULL DEFAULT 0,
    typesense_count INTEGER NOT NULL DEFAULT 0,
    baseline_latency_ms INTEGER,
    typesense_latency_ms INTEGER,
    request_path TEXT,
    sampled_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    metadata JSONB NOT NULL DEFAULT '{}'::jsonb
);

CREATE INDEX IF NOT EXISTS idx_search_shadow_comparisons_sampled_at
    ON public.cakegenie_search_shadow_comparisons (sampled_at DESC);

ALTER TABLE public.cakegenie_search_shadow_comparisons ENABLE ROW LEVEL SECURITY;

REVOKE ALL ON TABLE public.cakegenie_search_shadow_comparisons FROM anon, authenticated;
