-- Migration to update create_order_from_cart to handle session_id and use correct column names
...
BEGIN
    ...
    INSERT INTO public.cakegenie_orders (
        ...
        payment_status,
        recipient_name,
        delivery_phone, -- FIX: Use delivery_phone instead of recipient_phone
        delivery_address,
        delivery_city
    )
    VALUES (
        ...
        'pending',
        p_recipient_name,
        p_recipient_phone, -- Value comes from p_recipient_phone param
        p_delivery_address,
        p_delivery_city
    )
    ...
    -- FIX: Check both user_id and session_id to support guest checkout
