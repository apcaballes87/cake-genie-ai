-- Keep whitespace handling independent of SQL client backslash escaping.
-- This replaces the first rollout's equivalent \s+ expressions with POSIX
-- character classes so local, CLI, and MCP migration paths behave identically.
