...
const ListItem: React.FC<{ item: AnalysisItem; onClick: (item: AnalysisItem) => void }> = React.memo(({ item, onClick }) => {
...
export const FeatureList = React.memo<FeatureListProps>(({
    analysisError, analysisId, cakeInfo, basePriceOptions, mainToppers, supportElements, icingDesign, additionalInstructions,
