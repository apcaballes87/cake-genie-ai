...
// Build: v1.2.9 - Forced sync of page features and imports
...
export default function App(): React.ReactElement {
  ...
  const {
    ...
    analysisResult, analysisId, isAnalyzing, analysisError, isCustomizationDirty, dominantColors, setDominantColors,
  ...
  const renderAppState = () => {
    switch(appState) {
        ...
        case 'customizing': return <CustomizingPage 
            ...
            onDominantColorsChange={setDominantColors}
