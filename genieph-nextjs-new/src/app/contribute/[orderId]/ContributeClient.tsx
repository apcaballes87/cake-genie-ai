...
export default function ContributeClient({ orderId }: ContributeClientProps) {
    ...
    useEffect(() => {
        ...
        if (paymentStatus === 'success') {
            const verifyPayment = async () => {
                ...
                router.replace(`/contribute/${orderId}`);
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="max-w-md mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
                <div className="bg-linear-to-r from-purple-600 to-pink-500 p-6 text-white text-center">
                ...
                <div className="p-6 space-y-6">
                    ...
                    {(order.organizer || order.split_message) && (
                        <div className="bg-linear-to-r from-purple-50 to-pink-50 p-4 rounded-xl border border-purple-100">
                    ...
                    <div>
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-4 overflow-hidden">
                            <div
                                className="bg-linear-to-r from-green-400 to-green-600 h-full transition-all duration-500 ease-out"
                    ...
                    {order.order_status === 'cancelled' ? (
                        <div className="bg-red-50 border border-red-200 rounded-xl p-6 text-center">
                            ...
                            <p className="text-red-700 mt-1">This order has been cancelled by the organizer. Contributions are no longer accepted.</p>
                        </div>
                    ) : !isFullyFunded ? (
                        <form onSubmit={handleContribute} className="space-y-4 border-t border-gray-100 pt-6">
                            ...
                            <button
                                ...
                                className="w-full bg-linear-to-r from-purple-600 to-pink-600 text-white font-bold py-3 rounded-xl shadow-lg hover:shadow-xl transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                    ...
                    <div className="border-t border-gray-100 pt-6">
                        <div className="bg-linear-to-r from-pink-50 to-purple-50 p-5 rounded-xl border border-pink-200 text-center">
                            ...
                            <button
                                onClick={onNavigateHome}
                                className="w-full bg-linear-to-r from-pink-500 to-purple-600 text-white font-bold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all"
                            >
