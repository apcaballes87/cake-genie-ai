...
export const SideIcingGuideIcon: React.FC<{className?: string}> = ({className = "w-8 h-8 shrink-0"}) => (
    <img src="https://congofivupobtfudnhni.supabase.co/storage/v1/object/public/cakegenie/side%20icing.png" alt="Side icing guide" className={className} />
);

export const TopIcingGuideIcon: React.FC<{className?: string}> = ({className = "w-8 h-8 shrink-0"}) => (
    <img src="https://congofivupobtfudnhni.supabase.co/storage/v1/object/public/cakegenie/topicing.png" alt="Top icing guide" className={className} />
);

export const TopBorderGuideIcon: React.FC<{className?: string}> = ({className = "w-8 h-8 shrink-0"}) => (
    <img src="https://congofivupobtfudnhni.supabase.co/storage/v1/object/public/cakegenie/top%20border.png" alt="Top border guide" className={className} />
);

export const BaseBorderGuideIcon: React.FC<{className?: string}> = ({className = "w-8 h-8 shrink-0"}) => (
    <img src="https://congofivupobtfudnhni.supabase.co/storage/v1/object/public/cakegenie/baseborder.png" alt="Base border guide" className={className} />
);

export const BaseBoardGuideIcon: React.FC<{className?: string}> = ({className = "w-8 h-8 shrink-0"}) => (
    <img src="https://congofivupobtfudnhni.supabase.co/storage/v1/object/public/cakegenie/baseboard.png" alt="Base board guide" className={className} />
);
