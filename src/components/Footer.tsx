            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
                    <article className="genie-card genie-card-hover p-4 md:p-6 rounded-2xl text-center transition duration-300">
                        ...
                        <button onClick={() => router.push('/?upload=1')} className="genie-btn-primary px-6 py-2 rounded-full text-sm font-bold">
                            Upload here
                        </button>
                    </article>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <a href="https://www.tiktok.com/@genie.ph" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full genie-icon-button flex items-center justify-center">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-12 pt-6 border-t border-purple-200 flex flex-col md:flex-row items-center justify-between gap-4">
                        <p className="text-xs text-gray-400">
                            © {new Date().getFullYear()} Genie.ph | Alalai Information Technology Solutions
                        </p>
                        <button
                            onClick={scrollToTop}
