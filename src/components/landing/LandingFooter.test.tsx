...
describe('LandingFooter', () => {
  ...
  it('renders the featured badges at the bottom of the footer', () => {
    ...
    expect(markup).toContain('href="https://shinylaunch.com/product/genie"')
    expect(markup).toContain('title="Featured on ShinyLaunch"')
    expect(markup).toContain('src="https://shinylaunch.com/assets/images/badge.png"')
    expect(markup).toContain('alt="ShinyLaunch"')
  })
})
