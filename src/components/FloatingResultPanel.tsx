                                    ...
                                    <div className="flex space-x-1 bg-slate-100 p-0.5 rounded-md">
                                        ...
                                        {isOriginalPrintoutTopper && (
                                            <>
                                                ...
                                                <button onClick={() => updateMainTopper(item.id, { type: 'edible_photo_top' })} className={`px-2 py-1 text-[10px] font-semibold rounded ${item.type === 'edible_photo_top' ? 'bg-white shadow text-purple-700' : 'text-slate-600'}`}>Edible Image</button>
                                            </>
                                        )}
