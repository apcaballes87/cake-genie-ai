...
export const CustomizationBottomSheet: React.FC<CustomizationBottomSheetProps> = ({
    ...
    return (
        <div
            className={`fixed inset-x-0 z-80 flex justify-center pointer-events-none transition-all duration-500 ease-in-out ${!style?.bottom ? 'bottom-[80px]' : ''} ${wrapperClassName} ${!isVisible ? 'invisible' : ''}`}
            style={style}
