  ...
  return (
    <div className="w-full max-w-3xl mx-auto bg-white/70 backdrop-blur-lg p-8 rounded-2xl shadow-lg border border-slate-200 animate-fade-in">
      ...
      <div className="space-y-4 text-slate-600">
        <p>Welcome to Cake Genie! Our story will be shared here soon.</p>
        <p>We are passionate about creating beautiful and delicious cakes for every occasion. Stay tuned to learn more about our journey, our team, and our commitment to quality.</p>
