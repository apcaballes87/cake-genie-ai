...
const IcingToolbar = memo(function IcingToolbar({
    ...
    const tools = useMemo(() => (icingColorsSame ? [
        { id: 'drip', description: 'Drip', label: 'Drip', icon: <LazyImage src={getIcingImage(effectiveIcingDesign, 'drip')} alt="Drip effect" width={48} height={48} containerClassName="w-full h-full flex items-center justify-center" imageClassName="w-full h-full object-contain" unoptimized />, featureFlag: effectiveIcingDesign.drip },
        { id: 'borderTop', description: 'Top', label: 'Top Border', icon: <LazyImage src={getIcingImage(effectiveIcingDesign, 'borderTop')} alt="Top border" width={48} height={48} containerClassName="w-full h-full flex items-center justify-center" imageClassName="w-full h-full object-contain" unoptimized />, featureFlag: effectiveIcingDesign.border_top },
        { id: 'borderBase', description: 'Bottom', label: 'Base Border', icon: <LazyImage src={getIcingImage(effectiveIcingDesign, 'borderBase')} alt="Base border" width={48} height={48} containerClassName="w-full h-full flex items-center justify-center" imageClassName="w-full h-full object-contain" unoptimized />, featureFlag: effectiveIcingDesign.border_base, disabled: isBento },
        { id: 'icing', description: 'Body Icing', label: 'Body Icing', icon: <LazyImage src={getIcingImage(effectiveIcingDesign, 'top')} alt="Icing color" width={48} height={48} containerClassName="w-full h-full flex items-center justify-center" imageClassName="w-full h-full object-contain" unoptimized />, featureFlag: !!(effectiveIcingDesign.colors?.top || effectiveIcingDesign.colors?.side) },
        { id: 'gumpasteBaseBoard', description: 'Board', label: 'Board', icon: <LazyImage src={getIcingImage(effectiveIcingDesign, 'gumpasteBaseBoard')} alt="Gumpaste baseboard" width={48} height={48} containerClassName="w-full h-full flex items-center justify-center" imageClassName="w-full h-full object-contain" unoptimized />, featureFlag: effectiveIcingDesign.gumpasteBaseBoard, disabled: isBento },
    ] : [
        { id: 'drip', description: 'Drip', label: 'Drip', icon: <LazyImage src={getIcingImage(effectiveIcingDesign, 'drip')} alt="Drip effect" width={48} height={48} containerClassName="w-full h-full flex items-center justify-center" imageClassName="w-full h-full object-contain" unoptimized />, featureFlag: effectiveIcingDesign.drip },
        { id: 'borderTop', description: 'Top', label: 'Top Border', icon: <LazyImage src={getIcingImage(effectiveIcingDesign, 'borderTop')} alt="Top border" width={48} height={48} containerClassName="w-full h-full flex items-center justify-center" imageClassName="w-full h-full object-contain" unoptimized />, featureFlag: effectiveIcingDesign.border_top },
        { id: 'borderBase', description: 'Bottom', label: 'Base Border', icon: <LazyImage src={getIcingImage(effectiveIcingDesign, 'borderBase')} alt="Base border" width={48} height={48} containerClassName="w-full h-full flex items-center justify-center" imageClassName="w-full h-full object-contain" unoptimized />, featureFlag: effectiveIcingDesign.border_base, disabled: isBento },
        { id: 'top', description: 'Top Icing', label: 'Top Icing', icon: <LazyImage src={getIcingImage(effectiveIcingDesign, 'top', true)} alt="Top icing" width={48} height={48} containerClassName="w-full h-full flex items-center justify-center" imageClassName="w-full h-full object-contain" unoptimized />, featureFlag: !!effectiveIcingDesign.colors?.top },
        { id: 'side', description: 'Side Icing', label: 'Body Icing', icon: <LazyImage src={getIcingImage(effectiveIcingDesign, 'side')} alt="Side icing" width={48} height={48} containerClassName="w-full h-full flex items-center justify-center" imageClassName="w-full h-full object-contain" unoptimized />, featureFlag: !!effectiveIcingDesign.colors?.side },
        { id: 'gumpasteBaseBoard', description: 'Board', label: 'Board', icon: <LazyImage src={getIcingImage(effectiveIcingDesign, 'gumpasteBaseBoard')} alt="Gumpaste baseboard" width={48} height={48} containerClassName="w-full h-full flex items-center justify-center" imageClassName="w-full h-full object-contain" unoptimized />, featureFlag: effectiveIcingDesign.gumpasteBaseBoard, disabled: isBento },
