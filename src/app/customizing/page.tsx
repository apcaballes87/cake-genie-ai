...
const THEMES: { href: string; label: string; name: string }[] = [
    { href: '/birthday-cake-delivery-cebu-city', label: 'Birthday Cake Designs', name: 'Birthday Cakes' },
    ...
    { href: '/collections', label: 'Character Cake Designs', name: 'Character Cakes' },
    { href: '/collections/debut-cake', label: 'Debut Cake Designs', name: 'Debut Cakes' },
    { href: '/collections', label: 'Baptism Cake Designs', name: 'Baptism Cakes' },
                ...
                <div className="rounded-2xl border border-purple-100 bg-gradient-to-br from-purple-50/70 via-white to-pink-50/40 px-6 py-5 shadow-sm">
                    ...
                    <div className="grid sm:grid-cols-3 gap-x-6 gap-y-3 text-xs text-slate-500 leading-relaxed border-t border-purple-100 pt-4">
                        ...
                        <p>
                            ...
                            <Link href="/birthday-cake-delivery-cebu-city" className="text-purple-600 underline underline-offset-2 hover:text-purple-800">
                                birthday cakes
                            </Link>
                            ,{' '}
