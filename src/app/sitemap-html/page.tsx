                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <section>
                        ...
                        <ul className="space-y-3 pl-4 border-l-2 border-pink-100">
                            ...
                            <li><Link href="/cake-price-calculator" className="text-slate-600 hover:text-pink-600 font-medium">Cake Pricing Guide</Link></li>
                            <li><Link href="/party-budget-calculator" className="text-slate-600 hover:text-pink-600 font-medium">Party Budget Calculator</Link></li>
