  ...
  const renderLineItem = (categoryId: string, item: BudgetItem) => {
    ...
    return (
      <div key={item.id} className="py-3">
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)_76px_minmax(120px,0.9fr)_minmax(80px,auto)_minmax(140px,auto)] sm:items-start sm:gap-3">
