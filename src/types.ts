...
export type MainTopperType = 'edible_3d_complex' | 'edible_3d_ordinary' | 'edible_2d_complex' | 'printout' | 'toy' | 'figurine' | 'cardstock' | 'edible_photo_top' | 'edible_photo_print' | 'edible_logo_2d' | 'candle' | 'edible_2d_shapes' | 'edible_flowers' | 'icing_doodle' | 'icing_doodle_intricate' | 'icing_doodle_intricate_top' | 'icing_palette_knife' | 'icing_palette_knife_intricate' | 'icing_brush_stroke' | 'icing_splatter' | 'icing_minimalist_spread' | 'icing_decorations' | 'meringue_pop' | 'plastic_ball';
