...
export type CakeType = '1 Tier' | '2 Tier' | '3 Tier' | '1 Tier Fondant' | '2 Tier Fondant' | '3 Tier Fondant' | 'Square' | 'Rectangle' | 'Bento' | 'Square Fondant' | 'Rectangle Fondant' | 'cupcakes-printout-toppers' | 'cupcakes-edible-photo-toppers' | 'cupcakes-gumpaste-toppers-ordinary' | 'cupcakes-gumpaste-toppers-complex' | 'cupcakes-icing';
