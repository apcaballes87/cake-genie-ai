...
export type CakeType = '1 Tier' | '2 Tier' | '3 Tier' | '1 Tier Fondant' | '2 Tier Fondant' | '3 Tier Fondant' | 'Square' | 'Rectangle' | 'Slab Cake' | 'Bento' | 'Square Fondant' | 'Rectangle Fondant' | 'Cupcake' | 'Bento Cupcake Set';
