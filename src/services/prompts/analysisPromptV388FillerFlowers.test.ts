...
describe('v3.88 sized filler flower support normalization', () => {
  ...
  it('preserves historical v3.88 staging while v3.96 owns the active fallback', () => {
    ...
    const v391StageMigration = readProjectFile(
    ...
    expect(v391StageMigration).toContain("v390_md5 constant text := 'ac7f65da35135d3d4e42e90b7c82e655'");
    expect(v391StageMigration).toContain("v391_md5 constant text := 'fede0545b650c86737631e714bd918ee'");
  });
});
