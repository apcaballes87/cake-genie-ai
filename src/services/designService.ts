...
2.  **Technical Quality:** The final output MUST be a photorealistic image with the exact same pixel dimensions, aspect ratio, orientation, framing, and composition as the original input. Improve clarity and remove digital artifacts (like JPEG compression noise or pixelation) without cropping, stretching, padding, resizing, or changing the canvas. Do not artistically redraw or repaint existing physical textures.
