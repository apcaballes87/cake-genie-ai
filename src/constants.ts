...
export const CAKE_SIZE_THUMBNAILS: Record<string, string> = {
  ...
  '6"9"': `${storageBaseUrl}/2tier.webp`,
  '7"10"': `${storageBaseUrl}/2tier.webp`,
  '8"10"': `${storageBaseUrl}/2tier.webp`,
  '6"9" Fondant': `${storageBaseUrl}/2tier.webp`,
  '7"10" Fondant': `${storageBaseUrl}/2tier.webp`,
  '8"10" Fondant': `${storageBaseUrl}/2tier.webp`,
  // 3 Tier
  '6"/8"/10" Round': `${storageBaseUrl}/3tier.webp`,
  '5"8"10"': `${storageBaseUrl}/3tier.webp`,
  '6"9"12"': `${storageBaseUrl}/3tier.webp`,
  '7"10"14"': `${storageBaseUrl}/3tier.webp`,
  '5"8"10"Fondant': `${storageBaseUrl}/3tier.webp`,
  '6"9"12" Fondant': `${storageBaseUrl}/3tier.webp`,
  '7"10"14" Fondant': `${storageBaseUrl}/3tier.webp`,
  // Square
