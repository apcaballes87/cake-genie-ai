...
export function getDesignAvailability(design: DesignData): AvailabilityType {
    ...
    const hasHighlyComplexDecorations = allItems.some(item =>
        ['edible_3d_complex', 'edible_2d_complex', 'edible_3d_ordinary', 'edible_photo_side_wave', 'piped_flowers_top', 'piped_flowers_side'].includes(item.type) || // Handmade complex artwork, piped flower treatments, shaped wafer-paper waves, and 3D sculptures.
