...
describe('buildCakeTypePriceSummaries', () => {
  it('keeps canonical cake-type order and lowest price per size', () => {
    const summaries = buildCakeTypePriceSummaries([
      { type: 'Cupcake', thickness: '2 in', cakesize: 'Box of 6', price: 420, display_order: 2 },
      { type: '1 Tier', thickness: '3 in', cakesize: '6" Round', price: 950, display_order: 2 },
      { type: '1 Tier', thickness: '3 in', cakesize: '6" Round', price: 900, display_order: 2 },
    ...
    expect(summaries[0]).toMatchObject({
      ...
      defaultThickness: '4 in',
      thicknesses: ['3 in', '4 in'],
    });
    expect(summaries[0]?.priceGroups).toEqual([
      {
        thickness: '3 in',
        prices: [
