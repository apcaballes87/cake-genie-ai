...
export function buildImageStudioPrompt(brandLabel: string = 'genie.ph'): string {
  return [
    ...
    'Center the cake horizontally and position it vertically to leave substantial negative space (at least 25% of the image height) in the upper background area above the cake.',
    'Ensure the top background area is clean and uncluttered to accommodate a wide brand logo that will be floating behind and above the cake.',
