...
export function buildImageStudioPrompt(brandLabel: string = 'genie.ph'): string {
  return [
    ...
    'If its a cupcakes or cupcake set image, remove the box and cupcake holder, just show the cupcakes neatly together on the surface and retain the icing and design.',
