...
export function buildImageStudioPrompt(brandLabel: string = 'genie.ph'): string {
  return [
    ...
    'If it is a screenshot, collage, phone screenshot, marketplace page, or product grid, extract only the single main cake subject and discard everything else.',
    ...
    'Place the final cake on a solid light pastel purple cyclorama studio background.',
