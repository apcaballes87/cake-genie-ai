-- This SQL script creates the function to update amount_collected for designs
...
-- Notify that the migration was applied
SELECT 'Database migration applied successfully - Function update_design_amount_collected created' as message;